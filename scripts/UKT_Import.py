...
parser.add_argument('--debug', help="Specify Root Folder", default=False, action='store_true')
parser.add_argument('--input', type=str, help="Specify alternate output", required=True)
...
if not os.path.exists(input_file):
    ...
    sys.exit(1)
log.info("Input from file {}".format(input_file))
...
error_file = os.path.join(folder, 'UKT_Errors.xls')
